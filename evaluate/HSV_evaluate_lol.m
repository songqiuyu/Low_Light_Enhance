...
I1_out = imread('..\RetinexHSV\result\lol\1.png');

I2_in  = imread('..\..\..\PaperReproduction\DigitalImage\URetinex-Net-main\dataset\low\5.png');
I2_out = imread('..\RetinexHSV\result\lol\5.png');

I3_in  = imread('..\..\..\PaperReproduction\DigitalImage\URetinex-Net-main\dataset\low\13.png');
I3_out = imread('..\RetinexHSV\result\lol\13.png');

I4_in  = imread('..\..\..\PaperReproduction\DigitalImage\URetinex-Net-main\dataset\low\25.png');
I4_out = imread('..\RetinexHSV\result\lol\25.png');

I5_in  = imread('..\..\..\PaperReproduction\DigitalImage\URetinex-Net-main\dataset\low\39.png');
I5_out = imread('..\RetinexHSV\result\lol\39.png');

I6_in  = imread('..\..\..\PaperReproduction\DigitalImage\URetinex-Net-main\dataset\low\47.png');
I6_out = imread('..\RetinexHSV\result\lol\47.png');

I7_in  = imread('..\..\..\PaperReproduction\DigitalImage\URetinex-Net-main\dataset\low\53.png');
I7_out = imread('..\RetinexHSV\result\lol\53.png');

I8_in  = imread('..\..\..\PaperReproduction\DigitalImage\URetinex-Net-main\dataset\low\80.png');
I8_out = imread('..\RetinexHSV\result\lol\80.png');
